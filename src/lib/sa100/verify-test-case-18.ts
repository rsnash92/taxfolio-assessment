...
console.log(`  Minus PAYE deducted: £${input.employmentTaxDeducted}`)
console.log(`  Minus underpaid tax coded for 2025-26 (CAL8): £${underpaidTaxCAL8}`)
console.log(`  Total tax deducted: £${(input.employmentTaxDeducted + underpaidTaxCAL8).toFixed(2)}`)
console.log('')
console.log(`  Final: £${(11072.61 + underpaidTaxCAL7).toFixed(2)} - £${(input.employmentTaxDeducted + underpaidTaxCAL8).toFixed(2)} = £${(11072.61 + underpaidTaxCAL7 - input.employmentTaxDeducted - underpaidTaxCAL8).toFixed(2)}`)
